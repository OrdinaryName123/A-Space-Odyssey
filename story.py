...
endings = {
    "Good Ending": "Congratulations to you and the inhabitants of Earth for successfully interpreting these nine epics, preventing the resurgence of Azathoth, and restoring Earth to its former state. Recognizing the paramount importance of these epic narratives, the outer gods have decided to return Earth to a medieval era and have sealed off the potential for technological development, ensuring that Earth continues to perform and sustains Azathoth's peaceful slumber.",
    "Neutral Ending": "While you and the inhabitants of Earth managed to interpret some of the epic tales, you fell short of fully preventing the resurgence of Azathoth. As a result, Earth is returned to a medieval era, and its potential for technological development is sealed off. The universe remains in a delicate balance, with the looming threat of Azathoth's awakening.",
    "Bad Ending": "Despite your efforts, you and the inhabitants of Earth were unable to interpret the epic tales adequately. Azathoth's resurgence is inevitable, and the universe faces a cataclysmic obliteration. The denizens of Earth are left to witness the unfolding destruction as Azathoth." 
}
