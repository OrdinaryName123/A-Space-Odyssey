...
all_game_words = [key for key in locations.locations.keys()] + [key for key in command_variations.keys()] + [item.name for item in items.Items.values()] + [key for key in characters.Enemies.keys()] + ["north", "northeast", "southeast", "south", "southwest", "west", "northwest", "out"] + ['library', 'castle', 'garden', 'marketplace'] + ["pathfinder"]
...
#xy = normalize_input("USE ASTRAL BOW ON STELLAR SPHERE")
#print(xy)
