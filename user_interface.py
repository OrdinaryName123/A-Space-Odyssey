...
def print_menu(exits, choices, room_items, inv_items):
    ...
    print(colored(f"{colored('DISPLAY', attrs=['bold'])} SHOP or {colored('DISPLAY', attrs=['bold'])} STATS or {colored('DISPLAY', attrs=['bold'])} INVENTORY or {colored('DISPLAY', attrs=['bold'])} ITEM <NAME> or {colored('DISPLAY', attrs=['bold'])} ENEMY <NAME> or {colored('DISPLAY', attrs=['bold'])} ENEMIES.", "magenta"))
...
#print_room_items(locations["Azeroth"])
#print_menu(locations["Azeroth"]["exits"], locations["Azeroth"]["choices"], locations["Azeroth"]["items"], pathfinder.inventory)()